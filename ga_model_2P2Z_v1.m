function varargout=ga_model_2P2Z_v1(Nsupply,C_nut,varargin)
...
if flag.plot
    ...
    f_monod(N_theo_Nreg,N_theo_Nnew*0,arg.umax_small,arg.kNreg,1);
    f_monod(N_theo_Nnew,N_theo_Nreg*0,arg.umax_big,arg.kNnew,1);
    f_monod(output.Nreg,output.Nnew*0,arg.umax_small,arg.kNreg,1);
