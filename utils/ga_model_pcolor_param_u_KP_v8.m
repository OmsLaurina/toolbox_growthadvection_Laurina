function varargout=ga_model_pcolor_param_u_KP_v8(Nsupply,C_nut,varargin)
...
default_parameters={...
'umax_1',1.9872,'umax_2',2.7648,'gmax1',1.1126,'gmax2',1.4226,...% maximum growth and grazing rates (d^{-1}) (Baklouti et al., 2021)
...
min_umax2 = 1;
max_umax2 = 5;
l_umax2 = linspace(min_umax2,max_umax2,n);

min_kP2 = 1;
max_kP2 = 10;
l_kP2 = linspace(min_kP2,max_kP2,n);
ratio=zeros(length(l_umax2),length(l_kP2));
ratio2=zeros(length(l_umax2),length(l_kP2));
...
for umax_2=l_umax2
    ...
    for kP_2=l_kP2
        ...
        u_2=PO4(t-1)/(kP_2+PO4(t-1))*umax_2;
...
if flag.plot
    ...
    x = linspace(min_umax2,max_umax2,n);
    y = linspace(min_kP2,max_kP2,n);
    [X,Y] = meshgrid(x,y);
