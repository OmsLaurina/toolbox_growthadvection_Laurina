...
n2 = 100 #to reduce the number of line in the line plots 
...
if number_param == 2:
    ...
    for param1 in l_param1:
        ...
        for param2 in l_param2:
            [P1,P2,Z,PO4,Export,u1,u2,g1,g2,arg]=growth_model_2P1Z_v10(Psupply_arr*param2,time) #A modifier
            P_1[i,j] = P1[len(P1)-1]
            P_2[i,j] = P2[len(P2)-1]
...
with PdfPages(name_pdf) as pdf:
    ...
    if number_param == 2:   
        ...
        #P1/(P1+P2)
        plt.figure(3)
        plt.plot(l_param1[0:n2], Var[0:n2,0:n2], color='black')
        plt.grid()
        plt.xlabel(name_param1)
        plt.ylabel('P1/(P1+P2)')
        L_param2 = [round(num, 2) for num in l_param2]
