...
[P1,P2,Z,PO4,arg]=growth_model_2P1Z_v9(Psupply, time)
...
with PdfPages('outputs/model_V9/outputs_analysis_v9.pdf') as pdf:
    ...
    ## HOLLINGII
    plt.figure(3)
    P1_theo = np.linspace(0, 10, len(time))
    P2_theo = np.linspace(0, 10, len(time))
    ...
    f_hollingII(P1_theo, SUM_P, arg['gmax1'], arg['kZ'],"chartreuse")
    f_hollingII(P2_theo, SUM_P, arg['gmax2'], arg['kZ'],"green")
    f_hollingII(P1, SUM_P_array, arg['gmax1'], arg['kZ'],"blue")
    f_hollingII(P2, SUM_P_array, arg['gmax2'], arg['kZ'],"red")
