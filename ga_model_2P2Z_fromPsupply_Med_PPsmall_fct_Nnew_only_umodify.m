function varargout=ga_model_2P2Z_fromPsupply_Med_PPsmall_fct_Nnew_only_umodify(Nsupply,C_nut,varargin)
...
'P_small_ini',0.45,'P_big_ini',0.35,'Z_small_ini',0.3,'Z_big_ini',0.2};	% initial biomass (mmolC m^{-3}) (In situ for P_small_ini with method from Marrec et al., 2018 and Tzortzis et al., 2021 & further)
